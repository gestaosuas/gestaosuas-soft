...
class DashboardView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            directorates = []
        context.update({
            "profile": profile, "directorates": directorates,
            "cards": [
            ...
            "recent_submissions": safe_queryset(MonthlySubmission.objects.select_related("directorate").order_by("-created_at")),
            "recent_visits": safe_queryset(Visit.objects.select_related("osc", "directorate").order_by("-visit_date", "-created_at")),
        })
        return context
