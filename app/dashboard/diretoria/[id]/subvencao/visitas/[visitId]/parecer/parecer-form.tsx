...
export function OpinionReportForm({ visit, directorateId, directorateName = "", logoUrl }: ParecerFormProps) {
    ...
    const [report, setReport] = useState(() => {
        const defaultReport = {
            ...
            item4_type: "fully",
            item4_custom: "",
            item5_enabled: visit.atendimento?.pse_data?.item5_enabled || visit.pse_data?.item5_enabled || false,
            item5_periodo: visit.atendimento?.pse_data?.item5_periodo || visit.pse_data?.item5_periodo || "",
            item5_qualitativos: visit.atendimento?.pse_data?.item5_qualitativos || visit.pse_data?.item5_qualitativos || [
                { data: "", situacao: "", recomendacoes: "", observacao: "" },
                { data: "", situacao: "", recomendacoes: "", observacao: "" },
                { data: "", situacao: "", recomendacoes: "", observacao: "" },
                { data: "", situacao: "", recomendacoes: "", observacao: "" },
            ],
            item5_quantitativos: visit.atendimento?.pse_data?.item5_quantitativos || visit.pse_data?.item5_quantitativos || {
        ...
        return {
            ...
            item3_resultados: visit.parecer_tecnico.item3_resultados || "",
            item5_enabled: visit.parecer_tecnico.item5_enabled ?? defaultReport.item5_enabled,
            item5_periodo: visit.parecer_tecnico.item5_periodo || defaultReport.item5_periodo,
