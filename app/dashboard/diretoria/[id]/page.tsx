        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {(isSINE || isCP) ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <Link href={`/dashboard/relatorios/mensal?setor=beneficios&directorate_id=${directorate.id}`} className="group relative block w-full">
                    ...
                    <Link href={`/dashboard/relatorios/lista?setor=beneficios&directorate_id=${directorate.id}`} className="group relative block w-full">
