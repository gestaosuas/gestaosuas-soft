...
export default async function DashboardLayout({
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-zinc-50/50 dark:bg-zinc-950 font-sans antialiased text-zinc-900 dark:text-zinc-50 selection:bg-primary/10 selection:text-primary">
            ...
            <main className="flex-1 overflow-y-auto relative">
                ...
                <div className="h-full p-8 md:p-12 max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
                    {children}
                </div>
            </main>
        </div>
