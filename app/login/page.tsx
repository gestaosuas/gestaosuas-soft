        ...
        <div className="flex min-h-screen w-full items-center justify-center bg-white dark:bg-zinc-950 px-4 relative overflow-hidden">
            ...
            <main className="w-full max-w-[380px] animate-in fade-in slide-in-from-bottom-3 duration-1000">
                <header className="text-center mb-10 pt-8 flex flex-col items-center">
                    <div className="w-32 h-32 bg-white dark:bg-zinc-800 rounded-3xl flex items-center justify-center mb-8 shadow-2xl shadow-zinc-200/50 dark:shadow-none transform hover:scale-105 transition-all duration-500 border border-zinc-100 dark:border-zinc-700">
                        {/* eslint-disable-next-line @next/next/no-img-element */}
                        <img src="/logo-vigilancia.png" alt="Logo" className="w-20 h-20 object-contain" />
                    </div>
